SABESHADER can be described as an "anime" type shader for Blender models. It was developed for Blender 5.1.1 onward, so, it could not work in previous versions (test it out anyways, might work)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------
--------------------------------------------
